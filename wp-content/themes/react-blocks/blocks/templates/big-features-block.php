                    ...
                    <div class="feature flex">
                        <?php if ($feature['icon']) { ?>
                            <img src="<?php echo $feature['icon']['url']; ?>"
                                 alt="<?php echo $feature['icon']['url']; ?>" class="feature-icon">
                        <?php } ?>
                        <div class="feature-col">
                            <p class="feature-title"><?php echo $feature['title']; ?></p>
                            <p class="feature-description"><?php echo $feature['description']; ?></p>
                            <?php if ($feature['link']) { ?>
                                <a href="<?php echo $feature['link']['url']; ?>" class="feature-link"
                                   target="<?php if ($feature['link']['target']) {
                                       echo $feature['link']['target'];
                                   } else {
                                       echo '_self';
                                   } ?>"> <?php echo $feature['link']['title']; ?></a>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
